...
interface StatusPanelProps {
  ...
  onStepClick: (id: AssuranceStepId) => void;
        ...
        <Box sx={{ flexShrink: 0, borderTop: `1px solid ${color.outline.fixed}`, p: "16px" }}>
          ...
          >
            ...
            <TradAtlasText semanticFont={SF.textSm} sx={{ color: color.type.muted }}>
              The assurance report has been finalized and is ready for the Audit Committee.
            </TradAtlasText>
          </Box>
        </Box>
      ) : nextStep ? (
        <Box sx={{ flexShrink: 0, borderTop: `1px solid ${color.outline.fixed}`, p: "16px" }}>
          ...
          >
            ...
            {activeStepId === nextStep.id ? (
              <TradAtlasText semanticFont={SF.textSm} sx={{ color: color.type.muted, lineHeight: 1.45 }}>
                You’re on this step. Review the work area and use{" "}
                <strong>Approve</strong> (or the step action) when ready to move forward.
              </TradAtlasText>
            ) : (
              <Button
                variant="contained"
