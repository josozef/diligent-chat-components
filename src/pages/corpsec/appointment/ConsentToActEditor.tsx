      ...
      {editor ? (
        ...
        >
          ...
          >
            ...
            />
            <ToolbarBtn
              icon={<FormatItalicIcon sx={iconSz} />}
              label="Italic"
            ...
            />
            <ToolbarBtn
              icon={<FormatUnderlinedIcon sx={iconSz} />}
              label="Underline"
            ...
            <ToolbarBtn
              icon={<FormatListBulletedIcon sx={iconSz} />}
              label="Bullet list"
            ...
            />
            <ToolbarBtn
              icon={<FormatListNumberedIcon sx={iconSz} />}
              label="Numbered list"
            ...
            <ToolbarBtn
              icon={<HorizontalRuleIcon sx={iconSz} />}
              label="Horizontal rule"
              onClick={() => editor.chain().focus().setHorizontalRule().run()}
              {...btnProps}
            />
            <ToolbarBtn
              icon={<FormatClearIcon sx={iconSz} />}
